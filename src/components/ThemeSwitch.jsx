  ...
  return (
    <div className=" ml-3">
      ...
      >
        {theme === "dark" ? (
          <svg
            className="w-10 h-10 fill-slate-400 [filter:drop-shadow(-5px_-10px_15px_rgba(255,238,0,0.767))] hover:[filter:drop-shadow(-5px_-10px_17px_rgba(255,238,0,0.952))] hover:scale-105 transition-all"
            viewBox="0 0 24 24"
          >
            <path
              fill="#ffe600"
          ...
          <svg
            className="w-10 h-10 [filter:drop-shadow(0_0_15px_rgba(108,147,255,0.966))] hover:[filter:drop-shadow(0_0_17px_rgba(131,162,255,1))] fill-slate-100  hover:scale-105 transition-all"
            viewBox="0 0 24 24"
          >
            <path
